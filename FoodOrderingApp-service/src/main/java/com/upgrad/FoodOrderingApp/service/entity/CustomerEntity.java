...
public class CustomerEntity implements Serializable {
    ...
    public CustomerEntity(Integer id, @Size(max = 200) @NotNull String uuid, @Size(max = 30) @NotNull String firstName, @Size(max = 30) String lastName, @Size(max = 30) @NotNull String contactNumber, @Size(max = 50) String email, @Size(max = 255) @NotNull String password, @Size(max = 255) @NotNull String salt) {
        this.id = id;
        this.uuid = uuid;
